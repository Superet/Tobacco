...
(dv.col 	<- setdiff(names(match.shtdat), c( "treat", "household_code","after", "frac_seg", "smk")))
...
stargazer(list(blc, list(est.ols, est.mat, est.iv, est.fe)), type = "html", summary = FALSE, align = TRUE, no.space = TRUE, digits = 2,
