...
fit.ls1[[3]]	<- plm(q_othchannel ~ after + cvs_in2 + after*cvs_in2 , data = mydata1, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls1[[4]]	<- plm(q ~ after + cvs_in2 + after*cvs_in2 , data = mydata1, 
					index = c("household_code", "month"), model = "within") 
fit.ls1[[5]]	<- plm(q_othdrug ~ after + cvs_in2 + after*cvs_in2 , data = mydata1, 
					index = c("household_code", "month"), model = "within")
fit.ls1[[6]]	<- plm(q_othchannel ~ after + cvs_in2 + after*cvs_in2 , data = mydata1, 
					index = c("household_code", "month"), model = "within")
...
# ---------------------------------------------------------------------------- #
# DID linear regressions of Cigarette quantity with 3-way DID (Close Walgreen) #
fit.ls2	<- list(NULL)
fit.ls2[[1]]	<- plm(q ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 , data = mydata1, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls2[[2]]	<- plm(q_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 , data = mydata1, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls2[[3]]	<- plm(q_othchannel ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 , data = mydata1, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls2[[4]]	<- plm(q ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 , data = mydata1, 
					index = c("household_code", "month"), model = "within") 
fit.ls2[[5]]	<- plm(q_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 , data = mydata1, 
					index = c("household_code", "month"), model = "within")
fit.ls2[[6]]	<- plm(q_othchannel ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 , data = mydata1, 
					index = c("household_code", "month"), model = "within")

cls.se		<- lapply(fit.ls2, function(x) Cls.se.fn(x, cluster.vec = mydata1$household_code, est.table = FALSE)$se)

stargazer(fit.ls2, type = "html", align = TRUE, title = "3-way DID regressions of monthly cigarette quantity", 
...
# DID linear regressions of Cigarette quantity with 3-way DID (Close Walgreen) #
fit.ls3	<- list(NULL)
fit.ls3[[1]]	<- plm(q ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy , data = mydata1, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls3[[2]]	<- plm(q_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy , data = mydata1, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls3[[3]]	<- plm(q_othchannel ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy , data = mydata1, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls3[[4]]	<- plm(q ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy , data = mydata1, 
					index = c("household_code", "month"), model = "within") 
fit.ls3[[5]]	<- plm(q_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy , data = mydata1, 
					index = c("household_code", "month"), model = "within")
fit.ls3[[6]]	<- plm(q_othchannel ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy , data = mydata1, 
					index = c("household_code", "month"), model = "within")

cls.se		<- lapply(fit.ls3, function(x) Cls.se.fn(x, cluster.vec = mydata1$household_code, est.table = FALSE)$se)

stargazer(fit.ls3, type = "html", align = TRUE, title = "3-way DID regressions of monthly cigarette quantity", 
...
###################################
# DID regression of longer window # 
###################################			
# ----------------------------------------------------------- #
# DID linear regressions of Cigarette quantity with 2-way DID #
fit.ls4	<- list(NULL)
fit.ls4[[1]]	<- plm(q ~ after + cvs_in2 + after*cvs_in2 + month1, data = mydata, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls4[[2]]	<- plm(q_othdrug ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls4[[3]]	<- plm(q_othchannel ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls4[[4]]	<- plm(q ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within") 
fit.ls4[[5]]	<- plm(q_othdrug ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within")
fit.ls4[[6]]	<- plm(q_othchannel ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within")

cls.se		<- lapply(fit.ls4, function(x) Cls.se.fn(x, cluster.vec = mydata$household_code, est.table = FALSE)$se)

stargazer(fit.ls4, type = "html", align = TRUE, title = "DID regressions of monthly cigarette quantity", 
		keep = c("after", "cvs_in2"), se = cls.se,
		covariate.labels = c("After", "CloseDist", "After*CloseDist"),  
		add.lines = list(c("City FE", "FE","FE","FE","","",""), c("Household FE","","","","FE","FE","FE"), 
						 c("Month FE", "FE","FE","FE","FE","FE","FE")), 
		no.space = TRUE, omit.stat = c("rsq", "adj.rsq"), 
		notes = "S.E. clustered over households", 
...
# DID linear regressions of Cigarette quantity with 3-way DID (Close Walgreen) #
fit.ls5	<- list(NULL)
fit.ls5[[1]]	<- plm(q ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls5[[2]]	<- plm(q_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls5[[3]]	<- plm(q_othchannel ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls5[[4]]	<- plm(q ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within") 
fit.ls5[[5]]	<- plm(q_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within")
fit.ls5[[6]]	<- plm(q_othchannel ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within")

cls.se		<- lapply(fit.ls5, function(x) Cls.se.fn(x, cluster.vec = mydata$household_code, est.table = FALSE)$se)

stargazer(fit.ls5, type = "html", align = TRUE, title = "3-way DID regressions of monthly cigarette quantity", 
		keep = c("after", "cvs_in2", "wgr_in2"), se = cls.se,
		covariate.labels = c("After", "CloseDist", "CloseWgr", "After*CloseDist", 
							"After*CloseWgr", "CloseDist*CloseWgr", "After*CloseDist*CloseWgr"),  
		add.lines = list(c("City FE", "FE","FE","FE","","",""), c("Household FE","","","","FE","FE","FE"), 
...
# DID linear regressions of Cigarette quantity with 3-way DID (Close Walgreen) #
fit.ls6	<- list(NULL)
fit.ls6[[1]]	<- plm(q ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1, data = mydata, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls6[[2]]	<- plm(q_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1, data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls6[[3]]	<- plm(q_othchannel ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1, data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls6[[4]]	<- plm(q ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1, data = mydata, 
					index = c("household_code", "month"), model = "within") 
fit.ls6[[5]]	<- plm(q_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1, data = mydata, 
					index = c("household_code", "month"), model = "within")
fit.ls6[[6]]	<- plm(q_othchannel ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1, data = mydata, 
					index = c("household_code", "month"), model = "within")

cls.se		<- lapply(fit.ls6, function(x) Cls.se.fn(x, cluster.vec = mydata$household_code, est.table = FALSE)$se)

stargazer(fit.ls6, type = "html", align = TRUE, title = "3-way DID regressions of monthly cigarette quantity", 
		keep = c("after", "cvs_in2", "heavy"), se = cls.se,
		covariate.labels = c("After", "CloseDist", "Heavy", "After*CloseDist", 
							"After*Heavy", "CloseDist*Heavy", "After*CloseDist*Heavy"),  
		add.lines = list(c("City FE", "FE","FE","FE","","",""), c("Household FE","","","","FE","FE","FE"), 
