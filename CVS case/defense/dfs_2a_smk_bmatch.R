...
tmpx		<- exp(X[,paste("log_",selcol,sep="")])
...
sel3	<- mypan$household_code %in% match.pan[,"treat"] 	# Index of treated from bipartite
sel4	<- mypan$household_code %in% match.pan[,"control"]	# Index of control from bipartite
