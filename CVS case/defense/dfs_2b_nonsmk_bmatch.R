...
match.col			<- c("income", "age", "have_kids", "employment", "race", "log_distance_cvs", 
						"log_pre_trip_cvs", "pre_trip_othdrug", "log_pre_trip_othchannel", 
						"log_pre_dol_cvs", "pre_dol_othdrug", "log_pre_dol_othchannel")						
...
sel3	<- mypan$household_code %in% nonsmk.match[,"treat"] 	# Index of treated from bipartite
sel4	<- mypan$household_code %in% nonsmk.match[,"control"]	# Index of control from bipartite
