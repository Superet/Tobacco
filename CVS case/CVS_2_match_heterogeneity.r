...
plot.wd		<- getwd()
out.file	<- "cvs_match_heterogeneity"
ww			<- 6.5
ar			<- .6
...
mypan[mypan$ban_ard==1, "frac_seg"]			<- "Never"
...
match.mod	<- matchit(treat ~ income + age + have_kids + employment + race + distance_cvs +
                     ...
                     method = "nearest", data = mypan[,c("household_code","treat", "distance_cvs",demo.col,bhv.col)], ratio = my.ratio, replace = FALSE)
...
match.mod1	<- matchit(treat ~ income + age + have_kids + employment + race + distance_cvs +
                       pre_q + pre_trip_total + pre_trip_othchannel+ pre_dol_total + pre_dol_othchannel, 
                     method = "nearest", data = mypan[,c("household_code","treat", "distance_cvs",demo.col,bhv.col)], ratio = my.ratio, replace = TRUE)
...
lm.s	<- list(NULL)
lm.s[[1]]	<- plm(q ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within") 
lm.s[[2]]	<- plm(q_othdrug ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within")
lm.s[[3]]	<- plm(q_othchannel ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within")
lm.s[[4]]	<- plm(trip_cvs ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within")
lm.s[[5]]	<- plm(trip_othdrug ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within")
lm.s[[6]]	<- plm(trip_othchannel ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within")
lm.s[[7]]	<- plm(dol_cvs ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within") 
lm.s[[8]]	<- plm(dol_othdrug ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within")
lm.s[[9]]	<- plm(dol_othchannel ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                 index = c("household_code", "month"), model = "within")
lm.s[[10]]	<- plm(dol_total ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                  index = c("household_code", "month"), model = "within")					
lm.s[[11]]	<- plm(netdol_cvs ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                  index = c("household_code", "month"), model = "within") 
lm.s[[12]]	<- plm(netdol_othdrug ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                  index = c("household_code", "month"), model = "within")
lm.s[[13]]	<- plm(netdol_othchannel ~ after + frac_seg + after*frac_seg , data = mydata[sel.s,], 
                  index = c("household_code", "month"), model = "within")									 
...
lm.l	<- list(NULL)
lm.l[[1]]	<- plm(q ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within") 
lm.l[[2]]	<- plm(q_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within")
lm.l[[3]]	<- plm(q_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within")
lm.l[[4]]	<- plm(trip_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within")
lm.l[[5]]	<- plm(trip_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within")
lm.l[[6]]	<- plm(trip_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within")
lm.l[[7]]	<- plm(dol_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within") 
lm.l[[8]]	<- plm(dol_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within")
lm.l[[9]]	<- plm(dol_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                 index = c("household_code", "month"), model = "within")
lm.l[[10]]	<- plm(dol_total ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                  index = c("household_code", "month"), model = "within")					
lm.l[[11]]	<- plm(netdol_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                  index = c("household_code", "month"), model = "within") 
lm.l[[12]]	<- plm(netdol_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                  index = c("household_code", "month"), model = "within")
lm.l[[13]]	<- plm(netdol_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata, 
                  index = c("household_code", "month"), model = "within")									 
...
ivreg.s	<- list(NULL)
ivreg.s[[1]]	<- plm(q ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within") 
ivreg.s[[2]]	<- plm(q_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within")
ivreg.s[[3]]	<- plm(q_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within")
ivreg.s[[4]]	<- plm(trip_cvs ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within")
ivreg.s[[5]]	<- plm(trip_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within")
ivreg.s[[6]]	<- plm(trip_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within")
ivreg.s[[7]]	<- plm(dol_cvs ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within") 
ivreg.s[[8]]	<- plm(dol_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within")
ivreg.s[[9]]	<- plm(dol_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                    index = c("household_code", "month"), model = "within")
ivreg.s[[10]]	<- plm(dol_total ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                     index = c("household_code", "month"), model = "within")					
ivreg.s[[11]]	<- plm(netdol_cvs ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                     index = c("household_code", "month"), model = "within") 
ivreg.s[[12]]	<- plm(netdol_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                     index = c("household_code", "month"), model = "within")
ivreg.s[[13]]	<- plm(netdol_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match[sel.ivs,], 
                     index = c("household_code", "month"), model = "within")									 
...
ivreg.l	<- list(NULL)
ivreg.l[[1]]	<- plm(q ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within") 
ivreg.l[[2]]	<- plm(q_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within")
ivreg.l[[3]]	<- plm(q_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within")
ivreg.l[[4]]	<- plm(trip_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within")
ivreg.l[[5]]	<- plm(trip_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within")
ivreg.l[[6]]	<- plm(trip_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within")
ivreg.l[[7]]	<- plm(dol_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within") 
ivreg.l[[8]]	<- plm(dol_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within")
ivreg.l[[9]]	<- plm(dol_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                    index = c("household_code", "month"), model = "within")
ivreg.l[[10]]	<- plm(dol_total ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                     index = c("household_code", "month"), model = "within")					
ivreg.l[[11]]	<- plm(netdol_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                     index = c("household_code", "month"), model = "within") 
ivreg.l[[12]]	<- plm(netdol_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                     index = c("household_code", "month"), model = "within")
ivreg.l[[13]]	<- plm(netdol_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match, 
                     index = c("household_code", "month"), model = "within")									 
...
ivreg.rpl.s[[1]]	<- plm(q ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within") 
ivreg.rpl.s[[2]]	<- plm(q_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[3]]	<- plm(q_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[4]]	<- plm(trip_cvs ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[5]]	<- plm(trip_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[6]]	<- plm(trip_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[7]]	<- plm(dol_cvs ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within") 
ivreg.rpl.s[[8]]	<- plm(dol_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[9]]	<- plm(dol_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[10]]	<- plm(dol_total ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                     index = c("household_code1", "month"), model = "within")					
ivreg.rpl.s[[11]]	<- plm(netdol_cvs ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                     index = c("household_code1", "month"), model = "within") 
ivreg.rpl.s[[12]]	<- plm(netdol_othdrug ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                     index = c("household_code1", "month"), model = "within")
ivreg.rpl.s[[13]]	<- plm(netdol_othchannel ~ after + frac_seg + after*frac_seg , data = mydata.match1[sel.ivs1,], 
                     index = c("household_code1", "month"), model = "within")									 
...
ivreg.rpl.l[[1]]	<- plm(q ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within") 
ivreg.rpl.l[[2]]	<- plm(q_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[3]]	<- plm(q_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[4]]	<- plm(trip_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[5]]	<- plm(trip_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[6]]	<- plm(trip_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[7]]	<- plm(dol_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within") 
ivreg.rpl.l[[8]]	<- plm(dol_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[9]]	<- plm(dol_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                    index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[10]]	<- plm(dol_total ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                     index = c("household_code1", "month"), model = "within")					
ivreg.rpl.l[[11]]	<- plm(netdol_cvs ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                     index = c("household_code1", "month"), model = "within") 
ivreg.rpl.l[[12]]	<- plm(netdol_othdrug ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                     index = c("household_code1", "month"), model = "within")
ivreg.rpl.l[[13]]	<- plm(netdol_othchannel ~ after + frac_seg + after*frac_seg+month1, data = mydata.match1, 
                     index = c("household_code1", "month"), model = "within")									 
...
sel <- c("after:frac_segZero", "after:frac_segS1", "after:frac_segS2")
sel.lab	<- c("grp0", "grp1", "grp2")
...
rownames(tmp1) <- paste(rep(sapply(lm.s, function(x) as.character(x$formula[[2]])), each = length(sel)), sel.lab, sep=":")
class(tmp1)<- "coeftest"
coefls[[1]]<- tmp1
