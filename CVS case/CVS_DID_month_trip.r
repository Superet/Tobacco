...
# 2-way DID # 
glm.ls4	<- list(NULL)
glm.ls4[[1]]	<- glmer(trip_cvs ~ after + cvs_in2 + after*cvs_in2 + month1 + (1|scity) , data = mydata, family = binomial(link = "logit"))  
glm.ls4[[2]]	<- glmer(trip_othdrug ~ after + cvs_in2 + after*cvs_in2 + month1 + (1|scity) , data = mydata, family = binomial(link = "logit"))  
glm.ls4[[3]]	<- glmer(trip_cvs ~ after + cvs_in2 + after*cvs_in2 + month1 + (1|household_code) , data = mydata, family = binomial(link = "logit"))  
glm.ls4[[4]]	<- glmer(trip_othdrug ~ after + cvs_in2 + after*cvs_in2 + month1 + (1|household_code) , data = mydata, family = binomial(link = "logit"))  
...
# 3-way DID with Close to Walgreen #
glm.ls5	<- list(NULL)
glm.ls5[[1]]	<- glmer(trip_cvs ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + after*cvs_in2*wgr_in2 + month1 + (1|scity) , data = mydata, family = binomial(link = "logit"))  
glm.ls5[[2]]	<- glmer(trip_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + after*cvs_in2*wgr_in2 + month1 + (1|scity) , data = mydata, family = binomial(link = "logit"))  
glm.ls5[[3]]	<- glmer(trip_cvs ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + after*cvs_in2*wgr_in2 + month1 + (1|household_code) , data = mydata, family = binomial(link = "logit"))  
glm.ls5[[4]]	<- glmer(trip_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + after*cvs_in2*wgr_in2 + month1 + (1|household_code) , data = mydata, family = binomial(link = "logit"))  
...
# 3-way DID with heavy vs. light smokers #
glm.ls6	<- list(NULL)
glm.ls6[[1]]	<- glmer(trip_cvs ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + after*cvs_in2*heavy + month1 + (1|scity) , data = mydata, family = binomial(link = "logit"))  
glm.ls6[[2]]	<- glmer(trip_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + after*cvs_in2*heavy + month1 + (1|scity) , data = mydata, family = binomial(link = "logit"))  
glm.ls6[[3]]	<- glmer(trip_cvs ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + after*cvs_in2*heavy + month1 + (1|household_code) , data = mydata, family = binomial(link = "logit"))  
glm.ls6[[4]]	<- glmer(trip_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + after*cvs_in2*heavy + month1 + (1|household_code) , data = mydata, family = binomial(link = "logit"))  
...
# 2-way DID on spending # 
fit.ls4	<- list(NULL)
fit.ls4[[1]]	<- plm(dol_cvs ~ after + cvs_in2 + after*cvs_in2 + month1, data = mydata, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls4[[2]]	<- plm(dol_othdrug ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls4[[3]]	<- plm(dol_cvs ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within")
fit.ls4[[4]]	<- plm(dol_othdrug ~ after + cvs_in2 + after*cvs_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within") 
...
# DID linear regressions of spending with 3-way DID (Close Walgreen) #
fit.ls5	<- list(NULL)
fit.ls5[[1]]	<- plm(dol_cvs ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls5[[2]]	<- plm(dol_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls5[[3]]	<- plm(dol_cvs ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within") 
fit.ls5[[4]]	<- plm(dol_othdrug ~ after + cvs_in2 + wgr_in2 + after*cvs_in2 + after*wgr_in2 + cvs_in2*wgr_in2 + after*cvs_in2*wgr_in2 + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within")
...
# DID linear regressions of spending with 3-way DID (Close Walgreen) #
fit.ls6	<- list(NULL)
fit.ls6[[1]]	<- plm(dol_cvs ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within") 
fit.ls6[[2]]	<- plm(dol_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1 , data = mydata, 
					index = c("scity", "hhmonth"), model = "within")
fit.ls6[[3]]	<- plm(dol_cvs ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within") 
fit.ls6[[4]]	<- plm(dol_othdrug ~ after + cvs_in2 + heavy + after*cvs_in2 + after*heavy + cvs_in2*heavy + after*cvs_in2*heavy + month1 , data = mydata, 
					index = c("household_code", "month"), model = "within")
